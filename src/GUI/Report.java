            ...
            public void actionPerformed(ActionEvent e) {
                ...
                switch (rowData[1]) {
                    ...
                    case "Summary Report":
                        ...
                        taskData = DatabaseConnection.getTaskForShift(rowData[4], " 05:00:00", rowData[5], " 14:30:01", "Summary Report");
                        assert taskData != null;
                        ...
                        taskData = DatabaseConnection.getTaskForShift(rowData[4], " 14:30:01",rowData[5]," 21:59:59", "Summary Report");
                        assert taskData != null;
